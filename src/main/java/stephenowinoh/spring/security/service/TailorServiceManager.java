...
import stephenowinoh.spring.security.repository.ServiceRepository;
...
public class TailorServiceManager {
    ...
    public ServiceDTO createService(Long tailorId, ServiceDTO serviceDTO) {
        ...
        stephenowinoh.spring.security.model.Service service =
                new stephenowinoh.spring.security.model.Service();
        ...
        stephenowinoh.spring.security.model.Service saved = serviceRepository.save(service);
        return toDTO(saved);
    }
    ...
    public ServiceDTO updateService(Long serviceId, ServiceDTO serviceDTO) {
        ...
        stephenowinoh.spring.security.model.Service updated = serviceRepository.save(service);
     ...
     */
    private ServiceDTO toDTO(stephenowinoh.spring.security.model.Service service) {
